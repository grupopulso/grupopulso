...
export default async function ContasPagarPage({
  ...
  /*
   * Filtro por texto (fornecedor ou descrição), status e período —
   * feito em memória, no servidor, pelo mesmo motivo do
   * /financeiro/receber: o status é calculado na hora, não é uma
